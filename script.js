...
Container.className = "container-fluid bg-primary bg-gradient d-flex justify-content-center align-items-center"
...
fetch('https://restcountries.com/v3.1/all')
    ...
    .then(data => {
        data.forEach((data, index) => {
            ...
            CardHeader.className = "card-header bg-dark text-white fw-bold d-flex justify-content-center align-items-center"
